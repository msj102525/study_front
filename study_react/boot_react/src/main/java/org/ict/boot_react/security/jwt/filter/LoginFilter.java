...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public LoginFilter(MemberService memberService, RefreshTokenService refreshService, AuthenticationManager authenticationManager,
                JWTUtil jwtUtil) {
        this.memberService = memberService;
        this.refreshService = refreshService;
        this.authenticationManager = authenticationManager;
        this.jwtUtil = jwtUtil;
        this.accessExpiredMs = 1000 * 60 * 10L; // 10분
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        String username = customUserDetails.getUsername(); // 여기서는 userId 임
